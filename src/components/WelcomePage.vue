                            ...
                            <div class="clearfix">
                                ...
                                >
                                    ...
                                    <template v-slot:reference>
                                        <el-button class="float-right" size="mini" type="primary"
                                                   @click="seeClick">查看
                                        </el-button>
                                    </template>
                                </el-popover>
                ...
                <div class="block-4 clearfix">
                    ...
                    <el-card class="box-card">
                        <div class="text item">
                            <span>下单转化率</span>
                            <!--                            <p style="float: right;">-->
                            <!--                                {{ numFilter(mainInfo.addOrderNum / (mainInfo.newUser + mainInfo.oldUser)) }}</p>-->
                        </div>
                    ...
                    <el-card class="box-card">
                        <div class="text item">
                            <span>支付转化率</span>
                            <!--                            <p style="float: right;">-->
                            <!--                                {{ numFilter(mainInfo.payOrderNum / (mainInfo.newUser + mainInfo.oldUser)) }}</p>-->
                        </div>
