<template>
    <div class="content-page">
        ...
        <div class="content-main">
            ...
            <div class="form-table-box">
                <el-checkbox-group v-model="checkedCities" @change="handleCheckedCitiesChange">
                    <div v-for="item in tableData" :key="item" class="list-wrap clearfix">
                        ...
                        <div class="content-wrap clearfix">
                            <div class="left">
                                <div class="goods-list" :key="iitem" v-for="iitem in item.goodsList">
        ...
        <el-dialog title="打印快递单" v-model="dialogFormVisible">
            <el-form :model="dform">
                <div class="dialog-wrap">
                    <div class="list-wrap">
                        <div class="goods-list" :key="ditem" v-for="ditem in orderInfo.goodsList">
            ...
            <template v-slot:footer>
                <div class="dialog-footer print-footer">
                    <div class="f-left">
                    ...
                    <div class="f-right" v-if="dform.method == 1">
                        ...
                        <div v-if="rePrintStatus == 0">
                            <el-button v-if="autoGoDelivery" type="primary" @click="deliveyGoConfirm">打印快递单并发货
                            </el-button>
                            <el-button v-if="!autoGoDelivery" type="primary" @click="deliveyGoConfirm">只打印快递单
                            </el-button>
                        </div>
                        <div v-if="rePrintStatus == 1">
                            <el-button v-if="autoGoDelivery" type="primary" @click="directPrintConfirm">打印快递单并发货
                            </el-button>
                            <el-button v-if="!autoGoDelivery" type="primary" @click="directPrintConfirm">只打印快递单
                            </el-button>
                        </div>
                    </div>
                </div>
        ...
        <el-dialog title="提醒！" v-model="dialogExpressVisible">
            <div class="form-table-box">
        ...
        <el-dialog title="快递单预览" class="express-dialog" v-model="printMiandan">
            <div id="sfbj-block" v-if="expressType == 1 || expressType == 2"
                ...
                <div style="display: flex; width: 100%; justify-content: space-between; border-bottom: 1px solid #333;">
                    <div style="border-right: 1px solid #333;width:300px;text-align: center;">
                        <barcode :value="sfHasValue.LogisticCode" height="40" display-value="false"
                                 tag="img"></barcode>
                        <div
                            style="width: 100%; margin: 0 auto;text-align: center;font-size: 12px;padding-bottom: 2px;">
                ...
                <div style="display: flex;flex-direction: column;width: 100%;border-bottom: 1px solid #333;">
                    <div style="text-align:center;font-size: 32px;font-weight:bold;">{{ sfHasValue.DestinatioCode }}
                    </div>
                </div>
                <div
                    style="display: flex; justify-content: flex-start; border-bottom: 1px solid #333; position: relative;">
                    <div
                        style="width: 12px; padding: 0 2px; text-align: center; font-size: 10px; border-right: 1px solid #333; margin-right: 10px;">
                        收件人
                    </div>
                ...
                <div style="width:100%;text-align:center;height: 16px; font-size: 10px;border-bottom: 1px solid #333;">
                    寄件时间:{{ sfHasValue.send_time }},账号:{{ sfHasValue.MonthCode }},<label
                    v-if="sfHasValue.expressValue > 0">保价:{{ sfHasValue.expressValue }}元</label>
                </div>
            ...
            <div id="yto-block" v-if="expressType == 4"
                ...
                <div
                    style="display: flex; justify-content: flex-start; border-bottom: 1px solid #333; position: relative;">
                    <div
                        style="width: 12px; padding: 0 2px; text-align: center; font-size: 12px; border-right: 1px solid #333; margin-right: 10px;">
                        收件人
                    </div>
                    <div style="display: flex; flex-direction: column;">
                        <div style="display: flex; justify-content: flex-start; font-size: 12px;">
                ...
                <div
                    style="display: flex; justify-content: space-between; border-bottom: 1px solid #333; position: relative;">
        ...
        <el-dialog title="修改价格" v-model="dialogPriceVisible">
