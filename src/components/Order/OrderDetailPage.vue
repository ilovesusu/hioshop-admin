                    ...
                    <el-tab-pane label="订单信息" name="first">
                        ...
                        <div class="detail-wrap">
                            ...
                            <div class="total-price">
                                合计：¥{{ infoForm.actual_price }}（含运费：¥{{ infoForm.freight_price }}）
                            </div>
                            <div class="total-price">
                            ...
                            <div class="total-price">
                                {{
                                    infoForm.change_price - infoForm.actual_price > 0 ? '优惠金额：' + (infoForm.change_price - infoForm.actual_price).toFixed(2) : '涨价金额：' + (infoForm.actual_price - infoForm.change_price).toFixed(2)
                                }}
                            </div>
                        </div>
                        <div class="memo-wrap">
                    ...
                    <el-tab-pane label="物流信息" name="second">
                        ...
                        <div class="has-traces" v-else>
                            ...
                            <ul class="traces-wrap">
                                <li class="traces-list" :key="item" v-for="item in expressData.traces">
