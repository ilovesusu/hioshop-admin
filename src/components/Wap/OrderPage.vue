<template>
    <div class="wrap">
        ...
        <el-dialog title="发货" v-model="dialogFormVisible" width="94%">
            <el-form :model="dform">
                <div class="dialog-wrap">
                    <div class="d-list-wrap">
                        <div class="d-goods-list" :key="ditem" v-for="ditem in orderInfo.goodsList">
                            <img :src="ditem.list_pic_url" style="width: 40px;height: 40px;margin-right: 8px;"
                                 class="d-goods-img">
        ...
        <el-dialog title="修改价格" v-model="dialogPriceVisible" width="90%">
