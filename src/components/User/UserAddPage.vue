    ...
    <div class="content-page">
        ...
        <div class="content-main">
            ...
            <div class="form-table-box" v-if="this.pIndex == 0">
                <div v-for="item in orderData" :key="item" class="list-wrap clearfix">
            ...
            <div class="address-wrap" v-if="this.pIndex == 1">
                <div class="coupon-w">
                    ...
                    <div class="bottom" :key="item" v-for="item in addressData">
                        <div class="l">
...
export default {
    ...
    methods: {
        ...
        submitNick(index, row) {
            this.axios.post('user/updateInfo', {id: row.id, nickname: row.nickname}).then(() => {
